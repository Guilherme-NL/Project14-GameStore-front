...
export default function Products() {
  ...
  const search={searchTerm,setSearchTerm,searchCategory,setSearchCategory,searchOrder,setSearchOrder}
  function requestProductList(){
    const requisition=axios.get("https://gamemaster-project14.herokuapp.com/products?searchTerm="+searchTerm+"&searchCategory="+searchCategory+"&searchOrder="+searchOrder)
    //const requisition=axios.get("http://localhost:5000/products?searchTerm="+searchTerm+"&searchCategory="+searchCategory+"&searchOrder="+searchOrder)
